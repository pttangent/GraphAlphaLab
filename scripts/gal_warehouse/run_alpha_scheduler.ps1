...
$jobs = @(
  @{ Kind = 'WithinTheme'; Name = 'within_theme_trade_intensity_5m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_5m.parquet"; Contract = "$root\contracts\forward_5m.json"; Theme = $ThemeMemberships; FactorIds = 'trade_intensity_to_volatility__graph_forward'; Variants = 'graph_forward'; Direction = 'negative'; Temp = "$root\duckdb_tmp\within_theme_alpha\trade_intensity_5m"; Out = "$root\reports\within_theme_alpha\trade_intensity_5m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_trade_intensity_15m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_15m.parquet"; Contract = "$root\contracts\forward_15m.json"; Theme = $ThemeMemberships; FactorIds = 'trade_intensity_to_volatility__graph_forward'; Variants = 'graph_forward'; Direction = 'negative'; Temp = "$root\duckdb_tmp\within_theme_alpha\trade_intensity_15m"; Out = "$root\reports\within_theme_alpha\trade_intensity_15m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_trade_intensity_30m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_30m.parquet"; Contract = "$root\contracts\forward_30m.json"; Theme = $ThemeMemberships; FactorIds = 'trade_intensity_to_volatility__graph_forward'; Variants = 'graph_forward'; Direction = 'negative'; Temp = "$root\duckdb_tmp\within_theme_alpha\trade_intensity_30m"; Out = "$root\reports\within_theme_alpha\trade_intensity_30m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_trade_intensity_60m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_60m.parquet"; Contract = "$root\contracts\forward_60m.json"; Theme = $ThemeMemberships; FactorIds = 'trade_intensity_to_volatility__graph_forward'; Variants = 'graph_forward'; Direction = 'negative'; Temp = "$root\duckdb_tmp\within_theme_alpha\trade_intensity_60m"; Out = "$root\reports\within_theme_alpha\trade_intensity_60m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_trade_intensity_120m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_120m.parquet"; Contract = "$root\contracts\forward_120m.json"; Theme = $ThemeMemberships; FactorIds = 'trade_intensity_to_volatility__graph_forward'; Variants = 'graph_forward'; Direction = 'negative'; Temp = "$root\duckdb_tmp\within_theme_alpha\trade_intensity_120m"; Out = "$root\reports\within_theme_alpha\trade_intensity_120m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_trade_intensity_180m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_180m.parquet"; Contract = "$root\contracts\forward_180m.json"; Theme = $ThemeMemberships; FactorIds = 'trade_intensity_to_volatility__graph_forward'; Variants = 'graph_forward'; Direction = 'negative'; Temp = "$root\duckdb_tmp\within_theme_alpha\trade_intensity_180m"; Out = "$root\reports\within_theme_alpha\trade_intensity_180m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_implemented27_5m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_5m.parquet"; Contract = "$root\contracts\forward_5m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\implemented27_5m"; Out = "$root\reports\within_theme_alpha\implemented27_5m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_implemented27_15m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_15m.parquet"; Contract = "$root\contracts\forward_15m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\implemented27_15m"; Out = "$root\reports\within_theme_alpha\implemented27_15m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_implemented27_30m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_30m.parquet"; Contract = "$root\contracts\forward_30m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\implemented27_30m"; Out = "$root\reports\within_theme_alpha\implemented27_30m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_implemented27_60m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_60m.parquet"; Contract = "$root\contracts\forward_60m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\implemented27_60m"; Out = "$root\reports\within_theme_alpha\implemented27_60m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_implemented27_120m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_120m.parquet"; Contract = "$root\contracts\forward_120m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\implemented27_120m"; Out = "$root\reports\within_theme_alpha\implemented27_120m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_implemented27_180m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_180m.parquet"; Contract = "$root\contracts\forward_180m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\implemented27_180m"; Out = "$root\reports\within_theme_alpha\implemented27_180m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_remaining14_5m'; Batch = 'remaining14'; Signals = "$root\signals\remaining14"; Label = "$root\labels\forward_5m.parquet"; Contract = "$root\contracts\forward_5m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\remaining14_5m"; Out = "$root\reports\within_theme_alpha\remaining14_5m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_remaining14_15m'; Batch = 'remaining14'; Signals = "$root\signals\remaining14"; Label = "$root\labels\forward_15m.parquet"; Contract = "$root\contracts\forward_15m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\remaining14_15m"; Out = "$root\reports\within_theme_alpha\remaining14_15m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_remaining14_30m'; Batch = 'remaining14'; Signals = "$root\signals\remaining14"; Label = "$root\labels\forward_30m.parquet"; Contract = "$root\contracts\forward_30m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\remaining14_30m"; Out = "$root\reports\within_theme_alpha\remaining14_30m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_remaining14_60m'; Batch = 'remaining14'; Signals = "$root\signals\remaining14"; Label = "$root\labels\forward_60m.parquet"; Contract = "$root\contracts\forward_60m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\remaining14_60m"; Out = "$root\reports\within_theme_alpha\remaining14_60m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_remaining14_120m'; Batch = 'remaining14'; Signals = "$root\signals\remaining14"; Label = "$root\labels\forward_120m.parquet"; Contract = "$root\contracts\forward_120m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\remaining14_120m"; Out = "$root\reports\within_theme_alpha\remaining14_120m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_remaining14_180m'; Batch = 'remaining14'; Signals = "$root\signals\remaining14"; Label = "$root\labels\forward_180m.parquet"; Contract = "$root\contracts\forward_180m.json"; Theme = $ThemeMemberships; FactorIds = ''; Variants = 'graph_forward'; Direction = 'auto'; Temp = "$root\duckdb_tmp\within_theme_alpha\remaining14_180m"; Out = "$root\reports\within_theme_alpha\remaining14_180m" },
