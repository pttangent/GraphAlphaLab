...
$jobs = @(
  @{ Kind = 'WithinTheme'; Name = 'within_theme_trade_intensity_5m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_5m.parquet"; Contract = "$root\contracts\forward_5m.json"; Theme = $ThemeMemberships; FactorIds = 'trade_intensity_to_volatility__graph_forward'; Variants = 'graph_forward'; Direction = 'negative'; Temp = "$root\duckdb_tmp\within_theme_trade_intensity_5m"; Out = "$root\reports\within_theme_trade_intensity_5m" },
  @{ Kind = 'WithinTheme'; Name = 'within_theme_trade_intensity_15m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_15m.parquet"; Contract = "$root\contracts\forward_15m.json"; Theme = $ThemeMemberships; FactorIds = 'trade_intensity_to_volatility__graph_forward'; Variants = 'graph_forward'; Direction = 'negative'; Temp = "$root\duckdb_tmp\within_theme_trade_intensity_15m"; Out = "$root\reports\within_theme_trade_intensity_15m" },
  ...
  @{ Kind = 'WithinTheme'; Name = 'within_theme_trade_intensity_180m'; Batch = 'implemented27'; Signals = "$root\signals\implemented27"; Label = "$root\labels\forward_180m.parquet"; Contract = "$root\contracts\forward_180m.json"; Theme = $ThemeMemberships; FactorIds = 'trade_intensity_to_volatility__graph_forward'; Variants = 'graph_forward'; Direction = 'negative'; Temp = "$root\duckdb_tmp\within_theme_trade_intensity_180m"; Out = "$root\reports\within_theme_trade_intensity_180m" },
